    ...
    <AnimatePresence>
      {product && (
        ...
        >
          ...
          >
            <button ref={closeRef} onClick={handleClose} aria-label="Close" className="absolute top-5 right-5 text-white/30 hover:text-white/60 transition-colors cursor-pointer">
            ...
            <h2 id="modal-title" className="mt-4 text-2xl font-bold text-white">{product.title}</h2>
