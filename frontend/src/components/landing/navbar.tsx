        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-6">
            <button
              ...
              className="px-5 py-2 bg-gradient-to-r from-[#7C3AED] to-[#A855F7] hover:from-[#8B4AF7] hover:to-[#B565F7] text-white text-sm font-semibold rounded-xl glow-button transition-all duration-300 cursor-pointer"
            >
              Launch App
            </button>
          </div>
